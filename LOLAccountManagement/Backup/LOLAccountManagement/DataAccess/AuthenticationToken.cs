...
namespace LOLAccountManagement
{
    ...
    public sealed class AuthenticationToken
    {
        ...
        public AuthenticationToken(string deviceID, OperationContext context)
        {
            MessageProperties messageProperties = context.IncomingMessageProperties;
            RemoteEndpointMessageProperty endpointProperty = messageProperties[RemoteEndpointMessageProperty.Name] as RemoteEndpointMessageProperty;
            
            _AuthenticationToken = Guid.Empty;
            _AuthenticationDeviceID = deviceID;            
            _AuthenticationCreatedDate = DateTime.Now;
            _AuthenticationIPAddress = endpointProperty.Address;
        }
        ...
        public void Save()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand();
                if (string.IsNullOrEmpty(this.AuthenticationDeviceID))
                {
                    _AuthenticationToken = Guid.Empty;
                }
                else if (_AuthenticationToken == Guid.Empty)
                {
                    ...
                    _AuthenticationToken = Guid.NewGuid();
                }
                else
                {
